...
!define HELPURL "https://github.com/bitone/go-bitone/issues"
!define UPDATEURL "https://github.com/bitone/go-bitone/releases"
!define ABOUTURL "https://github.com/bitone/go-bitone#bitone-go"
...
Section "Geth" GETH_IDX
  ...
  # Firewall - add rules
  SimpleFC::AdvAddRule "Geth incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Bitone" 30303 "" "" ""
  SimpleFC::AdvAddRule "Geth outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Bitone" "" 30303 "" ""
  SimpleFC::AdvAddRule "Geth UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Bitone" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/bitone/EIPs/issues/147)
