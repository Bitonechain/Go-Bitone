...
import (
	...
	"github.com/bitone/go-bitone/internal/jsre"
...
func newTester(t *testing.T, confOverride func(*eth.Config)) *tester {
	...
	// Create a networkless protocol stack and start an Bitone service within
	...
	if err != nil {
		t.Fatalf("failed to register Bitone protocol: %v", err)
	}
