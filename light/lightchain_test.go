...
func makeHeaderChain(parent *types.Header, n int, db bitonedb.Database, seed int) []*types.Header {
...
// header only chain.
func newCanonical(n int) (bitonedb.Database, *LightChain, error) {
...
func (odr *dummyOdr) Database() bitonedb.Database {
	return odr.db
}
