 ...
 * @author Gary Rong<garyrong@bitone.org>, Martin Swende <martin.swende@bitone.org>
...
contract CheckpointOracle {
    ...
    */
    ...
    //
    // The default value should be the same as the checkpoint size(32768) in the bitone.
    uint sectionSize;
