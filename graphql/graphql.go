...
// Package graphql provides a GraphQL interface to Bitone node data.
package graphql
...
// Account represents an Bitone account at a particular block.
type Account struct {
...
// Transaction represents an Bitone transaction.
...
// Block represents an Bitone block.
...
type CallData struct {
	From     *common.Address // The Bitone address the call is from.
	To       *common.Address // The Bitone address the call is to.
