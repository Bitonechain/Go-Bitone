...
func makeMiner(genesis *core.Genesis) (*node.Node, *eth.Bitone, error) {
	// Define the basic configurations for the Bitone node
	...
	// Create the node and configure a full Bitone node on it
