...
import (
	...
	math2 "github.com/bitone/go-bitone/common/math"
...
// newAlethGenesisSpec converts a go-bitone genesis block into a Aleth-specific
// chain specification format.
func newAlethGenesisSpec(network string, genesis *core.Genesis) (*alethGenesisSpec, error) {
	// Only ethash is currently supported between go-bitone and aleth
...
type parityChainSpecPricing struct {
	...
	// Before the https://github.com/paritytech/parity-bitone/pull/11039,
...
// newParityChainSpec converts a go-bitone genesis block into a Parity specific
// chain specification format.
func newParityChainSpec(network string, genesis *core.Genesis, bootnodes []string) (*parityChainSpec, error) {
	// Only ethash is currently supported between go-bitone and Parity
	if genesis.Config.Ethash == nil {
		return nil, errors.New("unsupported consensus engine")
	}
	...
	// https://github.com/bitone/EIPs/blob/master/EIPS/eip-608.md
	spec.Params.EIP150Transition = hexutil.Uint64(genesis.Config.EIP150Block.Uint64())

	// Spurious Dragon: 155, 160, 161, 170
	// https://github.com/bitone/EIPs/blob/master/EIPS/eip-607.md
	...
	spec.Genesis.Seal.Bitone.Nonce = types.EncodeNonce(genesis.Nonce)
	spec.Genesis.Seal.Bitone.MixHash = (genesis.Mixhash[:])
	spec.Genesis.Difficulty = (*hexutil.Big)(genesis.Difficulty)
	spec.Genesis.Author = genesis.Coinbase
	spec.Genesis.Timestamp = (hexutil.Uint64)(genesis.Timestamp)
	spec.Genesis.ParentHash = genesis.ParentHash
...
// pyBitoneGenesisSpec represents the genesis specification format used by the
// Python Bitone implementation.
type pyBitoneGenesisSpec struct {
	Nonce      types.BlockNonce  `json:"nonce"`
	Timestamp  hexutil.Uint64    `json:"timestamp"`
	ExtraData  hexutil.Bytes     `json:"extraData"`
	GasLimit   hexutil.Uint64    `json:"gasLimit"`
...
// newPyBitoneGenesisSpec converts a go-bitone genesis block into a Parity specific
// chain specification format.
func newPyBitoneGenesisSpec(network string, genesis *core.Genesis) (*pyBitoneGenesisSpec, error) {
	// Only ethash is currently supported between go-bitone and pybitone
	if genesis.Config.Ethash == nil {
		return nil, errors.New("unsupported consensus engine")
	}
	spec := &pyBitoneGenesisSpec{
