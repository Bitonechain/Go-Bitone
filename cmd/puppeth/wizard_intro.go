...
// setting up a new or managing an existing Bitone private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your Bitone private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Bitone network down to  |")
	fmt.Println("| the genesis block, bootnodes, miners and bitonestats servers |")
	...
	log.Info("Administering Bitone network", "name", w.network)
