...
var (
	walletCommand = cli.Command{
		Name:      "wallet",
		Usage:     "Manage Bitone presale wallets",
		ArgsUsage: "",
		...
		Subcommands: []cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import Bitone presale wallet",
				ArgsUsage: "<keyFile>",
...
between bitone nodes by simply copying.
...
Note:
As you can directly copy your encrypted accounts to another bitone instance,
