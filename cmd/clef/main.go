...
import (
	...
	"github.com/bitone/go-bitone/signer/core"
	"github.com/bitone/go-bitone/signer/fourbyte"
	"github.com/bitone/go-bitone/signer/rules"
	"github.com/bitone/go-bitone/signer/storage"
...
func init() {
	app.Name = "Clef"
	app.Usage = "Manage Bitone account operations"
	app.Flags = []cli.Flag{
		logLevelFlag,
		keystoreFlag,
		configdirFlag,
