...
func (mc *mockCaller) CallContract(ctx context.Context, call bitone.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (mc *mockCaller) PendingCallContract(ctx context.Context, call bitone.CallMsg) ([]byte, error) {
