...
// Package bind generates Bitone contract Go bindings.
//
// Detailed usage document and tutorial available on the go-bitone Wiki page:
// https://github.com/bitone/go-bitone/wiki/Native-DApps:-Go-bindings-to-Bitone-contracts
package bind
