...
func NewTable(db bitonedb.Database, prefix string) bitonedb.Database {
	return &table{
		db:     db,
		prefix: prefix,
	}
...
func (t *table) NewIterator(prefix []byte, start []byte) bitonedb.Iterator {
...
func (t *table) NewBatch() bitonedb.Batch {
...
func (b *tableBatch) Replay(w bitonedb.KeyValueWriter) error {
