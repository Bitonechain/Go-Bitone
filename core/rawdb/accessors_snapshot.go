...
func ReadSnapshotRoot(db bitonedb.KeyValueReader) common.Hash {
...
// the persisted snapshot.
func WriteSnapshotRoot(db bitonedb.KeyValueWriter, root common.Hash) {
...
// invalid.
func DeleteSnapshotRoot(db bitonedb.KeyValueWriter) {
...
func ReadAccountSnapshot(db bitonedb.KeyValueReader, hash common.Hash) []byte {
	data, _ := db.Get(accountSnapshotKey(hash))
	return data
}

// WriteAccountSnapshot stores the snapshot entry of an account trie leaf.
func WriteAccountSnapshot(db bitonedb.KeyValueWriter, hash common.Hash, entry []byte) {
...
func DeleteAccountSnapshot(db bitonedb.KeyValueWriter, hash common.Hash) {
...
func ReadStorageSnapshot(db bitonedb.KeyValueReader, accountHash, storageHash common.Hash) []byte {
	data, _ := db.Get(storageSnapshotKey(accountHash, storageHash))
	return data
}

// WriteStorageSnapshot stores the snapshot entry of an storage trie leaf.
func WriteStorageSnapshot(db bitonedb.KeyValueWriter, accountHash, storageHash common.Hash, entry []byte) {
...
func DeleteStorageSnapshot(db bitonedb.KeyValueWriter, accountHash, storageHash common.Hash) {
...
func IterateStorageSnapshots(db bitonedb.Iteratee, accountHash common.Hash) bitonedb.Iterator {
	return db.NewIterator(storageSnapshotsKey(accountHash), nil)
}

// ReadSnapshotJournal retrieves the serialized in-memory diff layers saved at
// the last shutdown. The blob is expected to be max a few 10s of megabytes.
func ReadSnapshotJournal(db bitonedb.KeyValueReader) []byte {
...
func WriteSnapshotJournal(db bitonedb.KeyValueWriter, journal []byte) {
...
// the last shutdown
func DeleteSnapshotJournal(db bitonedb.KeyValueWriter) {
