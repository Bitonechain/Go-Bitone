...
import (
	...
	"github.com/bitone/go-bitone/bitonedb/leveldb"
	"github.com/bitone/go-bitone/bitonedb/memorydb"
...
type freezerdb struct {
	bitonedb.KeyValueStore
	bitonedb.AncientStore
}
...
func NewDatabase(db bitonedb.KeyValueStore) bitonedb.Database {
	return &nofreezedb{
		KeyValueStore: db,
	}
}
...
// storage.
func NewDatabaseWithFreezer(db bitonedb.KeyValueStore, freezer string, namespace string) (bitonedb.Database, error) {
...
func NewMemoryDatabase() bitonedb.Database {
...
func NewMemoryDatabaseWithCap(size int) bitonedb.Database {
	return NewDatabase(memorydb.NewWithCap(size))
}

// NewLevelDBDatabase creates a persistent key-value database without a freezer
// moving immutable chain segments into cold storage.
func NewLevelDBDatabase(file string, cache int, handles int, namespace string) (bitonedb.Database, error) {
...
// freezer moving immutable chain segments into cold storage.
func NewLevelDBDatabaseWithFreezer(file string, cache int, handles int, freezer string, namespace string) (bitonedb.Database, error) {
...
func InspectDatabase(db bitonedb.Database) error {
