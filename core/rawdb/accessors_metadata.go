...
func ReadDatabaseVersion(db bitonedb.KeyValueReader) *uint64 {
	var version uint64
...
func WriteDatabaseVersion(db bitonedb.KeyValueWriter, version uint64) {
...
func ReadChainConfig(db bitonedb.KeyValueReader, hash common.Hash) *params.ChainConfig {
...
func WriteChainConfig(db bitonedb.KeyValueWriter, hash common.Hash, cfg *params.ChainConfig) {
	if cfg == nil {
		return
	}
