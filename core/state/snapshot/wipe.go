...
func wipeSnapshot(db bitonedb.KeyValueStore, full bool) chan struct{} {
...
func wipeContent(db bitonedb.KeyValueStore) error {
...
func wipeKeyRange(db bitonedb.KeyValueStore, kind string, prefix []byte, keylen int) error {
