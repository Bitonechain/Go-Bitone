...
// SnapshotTree is an Bitone state snapshot tree. It consists of one persistent
...
type Tree struct {
	diskdb bitonedb.KeyValueStore      // Persistent database to store the snapshot
...
// background thread.
func New(diskdb bitonedb.KeyValueStore, triedb *trie.Database, cache int, root common.Hash, async bool) *Tree {
