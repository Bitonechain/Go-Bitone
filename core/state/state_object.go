...
// stateObject represents an Bitone account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of bitone address of the account
	data     Account
	db       *StateDB
...
// Account is the Bitone consensus representation of accounts.
