...
// Package state provides a caching layer atop the Bitone state trie.
package state
...
// StateDB structs within the bitone protocol are used to store anything
...
func (s *StateDB) Copy() *StateDB {
	...
	for addr := range s.journal.dirties {
		// As documented [here](https://github.com/bitone/go-bitone/pull/16485#issuecomment-380438527),
