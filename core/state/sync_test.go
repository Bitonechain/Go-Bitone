...
// account array.
func checkStateAccounts(t *testing.T, db bitonedb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db bitonedb.Database, root common.Hash) error {
...
func checkStateConsistency(db bitonedb.Database, root common.Hash) error {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(bitonedb.Database), srcRoot)
