...
// header only chain.
func newCanonical(engine consensus.Engine, n int, full bool) (bitonedb.Database, *BlockChain, error) {
	var (
...
func TestLightVsFastVsFullChainHeads(t *testing.T) {
	...
	makeDb := func() (bitonedb.Database, func()) {
...
//
// https://github.com/bitone/go-bitone/pull/15941
...
//
// Details at:
//  - https://github.com/bitone/go-bitone/issues/18977
//  - https://github.com/bitone/go-bitone/pull/18988
