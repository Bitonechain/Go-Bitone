...
import (
	...
	"github.com/bitone/go-bitone/p2p/enr"
...
type LesServer struct {
	...
	archiveMode bool // Flag whether the bitone node runs in archive mode.
	peers       *clientPeerSet
	serverset   *serverSet
...
func NewLesServer(node *node.Node, e *eth.Bitone, config *eth.Config) (*LesServer, error) {
