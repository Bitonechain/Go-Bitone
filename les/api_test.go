...
import (
	...
	"github.com/bitone/go-bitone/p2p/simulations"
	"github.com/bitone/go-bitone/p2p/simulations/adapters"
...
func newLesServerService(ctx *adapters.ServiceContext, stack *node.Node) (node.Lifecycle, error) {
	...
	bitone, err := eth.New(stack, &config)
	if err != nil {
		return nil, err
	}
	_, err = NewLesServer(stack, bitone, &config)
	if err != nil {
		return nil, err
	}
	return bitone, nil
