...
// NodeInfo represents a short summary of the Bitone sub-protocol metadata
// known about the host peer.
type NodeInfo struct {
	Network    uint64                   `json:"network"`    // Bitone network ID (1=Frontier, 2=Morden, Ropsten=3, Rinkeby=4)
...
func (c *lesCommons) setupOracle(node *node.Node, genesis common.Hash, ethconfig *eth.Config) *checkpointoracle.CheckpointOracle {
	...
	client := bitoneclient.NewClient(rpcClient)
	oracle.Start(client)
