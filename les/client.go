...
// Package les implements the Light Bitone Subprotocol.
package les
...
import (
	...
	"github.com/bitone/go-bitone/common/mclock"
	...
	lpc "github.com/bitone/go-bitone/les/lespay/client"
	"github.com/bitone/go-bitone/light"
...
func New(stack *node.Node, config *eth.Config) (*LightBitone, error) {
...
// APIs returns the collection of RPC services the bitone package offers.
// NOTE, some of these services probably need to be moved to somewhere else.
func (s *LightBitone) APIs() []rpc.API {
...
func (s *LightBitone) ResetWithGenesisBlock(gb *types.Block) {
	s.blockchain.ResetWithGenesisBlock(gb)
}

func (s *LightBitone) BlockChain() *light.LightChain      { return s.blockchain }
func (s *LightBitone) TxPool() *light.TxPool              { return s.txPool }
func (s *LightBitone) Engine() consensus.Engine           { return s.engine }
func (s *LightBitone) LesVersion() int                    { return int(ClientProtocolVersions[0]) }
func (s *LightBitone) Downloader() *downloader.Downloader { return s.handler.downloader }
func (s *LightBitone) EventMux() *event.TypeMux           { return s.eventMux }

// Protocols returns all the currently configured network protocols to start.
func (s *LightBitone) Protocols() []p2p.Protocol {
...
// light bitone protocol implementation.
func (s *LightBitone) Start() error {
